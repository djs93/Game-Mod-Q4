...
/*
===============
rvWeaponNailgun::MuzzleRise
===============
*/
void rvWeaponNailgun::MuzzleRise(idVec3 &origin, idMat3 &axis) {
	if (wsfl.zoom)
		return;
...
/*
===============
rvWeaponNailgun::UpdateCylinders
===============
*/
void rvWeaponNailgun::UpdateCylinders(void)
{
	idAnimator* animator;
...
STATE("EmptyReload", rvWeaponNailgun::State_EmptyReload)
STATE("MoveCylinder", rvWeaponNailgun::Frame_MoveCylinder)
STATE("ResetCylinder", rvWeaponNailgun::Frame_ResetCylinder)
END_CLASS_STATES
...
================
*/
stateResult_t rvWeaponNailgun::State_EmptyReload(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
stateResult_t rvWeaponNailgun::Frame_MoveCylinder(const stateParms_t& parms) {
	cylinderState = CYLINDER_MOVE_POSITION;
	return SRESULT_OK;
}

stateResult_t rvWeaponNailgun::Frame_ResetCylinder(const stateParms_t& parms) {
	cylinderState = CYLINDER_RESET_POSITION;
	return SRESULT_OK;
}

void rvWeaponNailgun::SpectatorCycle(void) {
	cylinderState = CYLINDER_RESET_POSITION;
}
