...
/*
================
rvWeaponGrenadeLauncher::OnLaunchProjectile
================
*/
...
/*
================
rvWeaponGrenadeLauncher::SetRocketState
================
*/
void rvWeaponGrenadeLauncher::SetRocketState(const char* state, int blendFrames) {
	rocketThread.SetState(state, blendFrames);
}

/*
=====================
rvWeaponGrenadeLauncher::Save
=====================
*/
void rvWeaponGrenadeLauncher::Save(idSaveGame *saveFile) const {
...
/*
=====================
rvWeaponGrenadeLauncher::Restore
=====================
*/
void rvWeaponGrenadeLauncher::Restore(idRestoreGame *saveFile) {
	int numEnts = 0;
	idEntity* ent = NULL;
...
STATE("Raise", rvWeaponGrenadeLauncher::State_Raise)
STATE("Lower", rvWeaponGrenadeLauncher::State_Lower)

STATE("Rocket_Idle", rvWeaponGrenadeLauncher::State_Rocket_Idle)
STATE("Rocket_Reload", rvWeaponGrenadeLauncher::State_Rocket_Reload)

STATE("AddToClip", rvWeaponGrenadeLauncher::Frame_AddToClip)
END_CLASS_STATES


/*
================
rvWeaponGrenadeLauncher::State_Raise

Raise the weapon
================
*/
stateResult_t rvWeaponGrenadeLauncher::State_Raise(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponGrenadeLauncher::State_Lower

Lower the weapon
================
*/
stateResult_t rvWeaponGrenadeLauncher::State_Lower(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
rvWeaponGrenadeLauncher::State_Rocket_Idle
================
*/
stateResult_t rvWeaponGrenadeLauncher::State_Rocket_Idle(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITEMPTY,
...
/*
================
rvWeaponGrenadeLauncher::State_Rocket_Reload
================
*/
stateResult_t rvWeaponGrenadeLauncher::State_Rocket_Reload(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};
...
/*
================
rvWeaponGrenadeLauncher::Frame_AddToClip
================
*/
stateResult_t rvWeaponGrenadeLauncher::Frame_AddToClip(const stateParms_t& parms) {
	AddToClip(1);
	return SRESULT_OK;
}
